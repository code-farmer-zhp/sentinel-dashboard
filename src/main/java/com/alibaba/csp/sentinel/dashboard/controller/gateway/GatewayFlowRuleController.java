...
public class GatewayFlowRuleController {
    ...
    @Autowired
    @Qualifier("gatewayFlowRuleStore")
    private DynamicRuleStore<GatewayFlowRuleEntity> dynamicRuleStore;
    ...
    public Result<GatewayFlowRuleEntity> updateFlowRule(@RequestBody UpdateFlowRuleReqVo reqVo) {
        ...
        GatewayFlowRuleEntity entity = dynamicRuleStore.findById(reqVo.getApp(), id);
        if (entity == null) {
