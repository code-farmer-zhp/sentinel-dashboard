...
@Component("paramFlowRuleStore")
public class ParamFlowRuleNacosStore extends AbstractNacosDynamicRuleStore<ParamFlowRuleEntity> {
    @Override
    public void preSave(ParamFlowRuleEntity entity) {
