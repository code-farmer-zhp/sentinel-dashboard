 ...
 * @since 1.4.0
 */
@Component("flowRuleStore")
public class FlowRuleNacosStore extends AbstractNacosDynamicRuleStore<FlowRuleEntity> {

    @Override
    public void preSave(FlowRuleEntity entity) {
        if (entity.isClusterMode()) {
