...
public class DegradeController {
    ...
    @Autowired
    @Qualifier("degradeRuleStore")
    private DynamicRuleStore<DegradeRuleEntity> dynamicRuleStore;
    ...
    public Result<DegradeRuleEntity> apiUpdateRule(@PathVariable("id") Long id,
        ...
        DegradeRuleEntity oldEntity = dynamicRuleStore.findById(entity.getApp(), id);
        if (oldEntity == null) {
