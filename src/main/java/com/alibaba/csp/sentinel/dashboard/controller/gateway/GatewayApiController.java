...
public class GatewayApiController {
    ...
    @Autowired
    private DynamicRuleStore<ApiDefinitionEntity> dynamicRuleStore;
    ...
    public Result<ApiDefinitionEntity> addApi(HttpServletRequest request, @RequestBody AddApiReqVo reqVo) {
        ...
        // 检查API名称不能重复
        List<ApiDefinitionEntity> allApis = dynamicRuleStore.list(app);
    ...
    public Result<ApiDefinitionEntity> updateApi(@RequestBody UpdateApiReqVo reqVo) {
        ...
        ApiDefinitionEntity entity = dynamicRuleStore.findById(reqVo.getApp(), id);
        if (entity == null) {
