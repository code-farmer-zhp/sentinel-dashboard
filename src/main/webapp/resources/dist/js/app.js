...
angular.module("sentinelDashboardApp",
               ["oc.lazyLoad", "ui.router", "ui.bootstrap", "angular-loading-bar", "ngDialog",
                "ui.bootstrap.datetimepicker", "ui-notification", "rzTable", "angular-clipboard",
                "selectize", "angularUtils.directives.dirPagination"])
    .factory("AuthInterceptor", ["$window", "$state", function (r, t) {
        return {
            responseError: function (e) {
                return 401 === e.status && (r.localStorage.removeItem(
                    "session_sentinel_admin"), t.go("login")), e
            }, response: function (e) {
                return e
            }, request: function (e) {
                ...
                function (e, t, r, a) {
                    a.interceptors.push("AuthInterceptor"), r.config(
                        {debug: !1, events: !0}), t.otherwise("/dashboard/home"), e.state("login", {
                        url: "/login",
                        ...
                        resolve: {
                            loadMyDirectives: ["$ocLazyLoad", function (e) {
                                return e.load({
                                                  name: "sentinelDashboardApp",
                                                  files: ["app/scripts/directives/header/header.js",
...
}]), (app = angular.module("sentinelDashboardApp")).service("VersionService",
                                                            ["$http", function (e) {
    ...
    angular.module("sentinelDashboardApp")).service("AuthService", ["$http", function (t) {
    this.check = function () {
...
}]), (app = angular.module("sentinelDashboardApp")).service("FlowServiceV1",
                                                            ["$http", function (a) {
                                                                function t(e) {
                                                                    return void 0 === e || "" === e
                                                                           || isNaN(e) || e <= 0
                                                                                     ...
                                                                                     ? void 0
                                                                                       ...
                                                                                       < 0 ? (alert(
                                                                                           ...
                                                                                           : 1
                                                                                             ...
                                                                                             : 2
                                                                                               == e.controlBehavior
                                                                                               && t(e.maxQueueingTimeMs)
                                                                                               ? (alert("排队超时时间必须大于 0"), !1)
                                                                                               : !e.clusterMode
                                                                                                 || void 0
                                                                                                 !== e.clusterConfig
                                                                                                 && void 0
                                                                                                 !== e.clusterConfig.thresholdType
                                                                                                 || (alert(
                                                                                                        "集群限流配置不正确"), !1)
                                                                                     : (alert(
                                                                                            "请填写关联资源或入口"), !1)
    ...
    angular.module("sentinelDashboardApp")).service("FlowServiceV2", ["$http", function (a) {
    function t(e) {
    ...
    this.queryMachineRules = function (e, t, r) {
        ...
        return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"), !1) : void 0
                                                                                      === e.count
                                                                                      || e.count < 0
                                                                                      ? (alert(
                "限流阈值必须大于等于 0"), !1) : void 0 === e.strategy || e.strategy < 0 ? (alert(
                "无效的流控模式"), !1) : 1 != e.strategy && 2 != e.strategy || void 0 !== e.refResource
                                  && "" != e.refResource ? void 0 === e.controlBehavior
                                                           || e.controlBehavior < 0 ? (alert(
                "无效的流控整形方式"), !1) : 1 == e.controlBehavior && t(e.warmUpPeriodSec) ? (alert(
                "预热时长必须大于 0"), !1) : 2 == e.controlBehavior && t(e.maxQueueingTimeMs) ? (alert(
                "排队超时时间必须大于 0"), !1) : !e.clusterMode || void 0 !== e.clusterConfig && void 0
                                       !== e.clusterConfig.thresholdType || (alert("集群限流配置不正确"), !1)
                                                         : (alert("请填写关联资源或入口"), !1)
    }
}]), (app = angular.module("sentinelDashboardApp")).service("DegradeService",
                                                            ["$http", function (a) {
                                                                this.queryMachineRules =
                                                                    function (e, t, r) {
                                                                        return a({
                                                                    ...
                                                                    function (e) {
                                                                        ...
                                                                        if (0 == e.grade) {
                                                                            if (null
                                                                                == e.slowRatioThreshold) {
                                                                                return alert(
                                                                                    "慢调用比率不能为空"), !1;
                                                                            }
                                                                            if (e.slowRatioThreshold
                                                                                < 0 || 1
                                                                                < e.slowRatioThreshold) {
                                                                                return alert(
                                                                                    "慢调用比率超出范围：[0.0 - 1.0]"), !1
    ...
    angular.module("sentinelDashboardApp")).service("SystemService", ["$http", function (a) {
    this.queryMachineRules = function (e, t, r) {
        return a({url: "system/rules.json", params: {app: e, ip: t, port: r}, method: "GET"})
    }, this.newRule = function (e) {
        var t = {app: e.app, ip: e.ip, port: e.port};
        return 0 == e.grade ? t.highestSystemLoad = e.highestSystemLoad : 1 == e.grade ? t.avgRt =
            e.avgRt : 2 == e.grade ? t.maxThread = e.maxThread : 3 == e.grade ? t.qps = e.qps : 4
                                                                                                == e.grade
                                                                                                && (t.highestCpuUsage =
                e.highestCpuUsage), a({url: "/system/new.json", params: t, method: "GET"})
    }, this.saveRule = function (e) {
        var t = {id: e.id};
        return 0 == e.grade ? t.highestSystemLoad = e.highestSystemLoad : 1 == e.grade ? t.avgRt =
            e.avgRt : 2 == e.grade ? t.maxThread = e.maxThread : 3 == e.grade ? t.qps = e.qps : 4
                                                                                                == e.grade
                                                                                                && (t.highestCpuUsage =
                e.highestCpuUsage), a({url: "/system/save.json", params: t, method: "GET"})
    }, this.deleteRule = function (e) {
        var t = {id: e.id, app: e.app};
        return a({url: "/system/delete.json", params: t, method: "GET"})
    }
}]), (app = angular.module("sentinelDashboardApp")).service("MachineService",
    ...
    angular.module("sentinelDashboardApp")).service("IdentityService", ["$http", function (a) {
    this.fetchIdentityOfMachine = function (e, t, r) {
        return a({
                     url: "resource/machineResource.json",
                     params: {ip: e, port: t, searchKey: r},
                     method: "GET"
                 })
...
}]), (app = angular.module("sentinelDashboardApp")).service("MetricService",
                                                            ["$http", function (n) {
                                                                this.queryAppSortedIdentities =
                                                                    function (e) {
                                                                        return n({
                                                                    ...
                                                                    }, this.queryByMachineAndIdentity =
                                                                    function (e, t, r, a, o) {
                                                                        var l = {
                                                                            ip: e,
                                                                            port: t,
    ...
    "sentinelDashboardApp").service("ParamFlowService", ["$http", function (a) {
    function o(e) {
        return !("int" !== (r = e.classType) && "double" !== r && "float" !== r && "long" !== r
               && "short" !== r || void 0 !== (t = e.object) && "" !== t && !isNaN(t)) || (!!("byte"
                                                                                              === e.classType
                                                                                              && (a =
                e.object, o = -128, l = 127, void 0 === a || "" === a || isNaN(a) || a < o || l
                                             < a)) || (void 0 === e.object || void 0 === e.classType
               || (void 0 === (n = e.count) || "" === n || isNaN(n) || n < 0)));
        var t, r, a, o, l, n
    }
    ...
    this.queryMachineRules = function (e, t, r) {
        ...
        if (!e.resource || "" === e.resource) {
            return alert("资源名称不能为空"), !1;
        }
        if (1 != e.grade) {
            return alert("未知的限流模式"), !1;
        }
        if (e.count < 0) {
            return alert("限流阈值必须大于等于 0"), !1;
        }
        if (void 0 === e.paramIdx || "" === e.paramIdx || isNaN(e.paramIdx) || e.paramIdx
            < 0) {
            return alert("热点参数索引必须大于等于 0"), !1;
        }
        if (void 0 !== e.paramFlowItemList) {
            for (var t = 0; t < e.paramFlowItemList.length; t++) {
                ...
                if (o(r)) {
                    return alert(
                        "热点参数例外项不合法，请检查值和类型是否正确：参数为 " + r.object + ", 类型为 " + r.classType
                        + ", 限流阈值为 "
                        + r.count), !1
                }
            }
    ...
    this.queryMachineRules = function (e, t, r) {
        ...
        return void 0 === e.resource || "" === e.resource ? (alert("资源名称不能为空"), !1) : void 0
                                                                                      ...
                                                                                      === e.limitApp
                                                                                      ? (alert(
                "流控针对应用不能为空"), !1) : void 0 !== e.strategy || (alert("必须选择黑白名单模式"), !1)
    }
...
}]), (app = angular.module("sentinelDashboardApp")).service("GatewayApiService",
                                                            ["$http", function (a) {
                                                                this.queryApis =
                                                                    function (e, t, r) {
                                                                        return a({
                                                                    ...
                                                                    function (e, t) {
                                                                        ...
                                                                        if (null == e.predicateItems
                                                                            || 0
                                                                            === e.predicateItems.length) {
                                                                            return alert(
                                                                                "至少有一个匹配规则"), !1;
                                                                        }
                                                                        for (var r = 0; r
    ...
    angular.module("sentinelDashboardApp")).service("GatewayFlowService", ["$http", function (a) {
    this.queryRules = function (e, t, r) {
        ...
        if (void 0 === e.resource || "" === e.resource) {
            return alert("API名称不能为空"), !1;
        }
        if (null != e.paramItem && (2 == e.paramItem.parseStrategy || 3 == e.paramItem.parseStrategy
                                    || 4 == e.paramItem.parseStrategy)) {
            if (void 0 === e.paramItem.fieldName || "" === e.paramItem.fieldName) {
                return alert(
                    "当参数属性为Header、URL参数、Cookie时，参数名称不能为空"), !1;
            }
            if ("" === e.paramItem.pattern) {
                return alert("匹配串不能为空"), !1
            }
        }
        return !(void 0 === e.count || e.count < 0) || (alert(
            (1 === e.grade ? "QPS阈值" : "线程数") + "必须大于等于 0"), !1)
    }
}]);